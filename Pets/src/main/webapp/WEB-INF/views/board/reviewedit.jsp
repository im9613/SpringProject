...
<section class="notice" id="review-edit-section">
    <div class="page-title" id="review-edit-title">
        <h2>후기 수정 <small></small></h2>
    </div>
    
    <form method="POST" action="${pageContext.request.contextPath}/revieweditok.do" id="review-edit-form">
        <div class="container" id="review-edit-container">
            <table class="table" id="review-edit-table">
                <tr>
                    <th class="table-th">제목</th>
                    <td><input type="text" name="title" required class="form-input full" value="${AdoptReviewListDTO.title}" id="review-title"></td>
                </tr>
                <tr>
                    <th class="table-th">내용</th>
                    <td><textarea name="content" required class="form-textarea full" style="width: 600px; height: 500px;" id="review-content">${AdoptReviewListDTO.content}</textarea></td>
                </tr>
            </table>
            <input type="hidden" name="seq" value="${AdoptReviewListDTO.seq}">
            <div class="form-button-group" id="review-edit-button-group">
                <button class="btn btn-primary" type="submit" id="submit-button">수정하기</button>
                <button class="btn btn-primary" type="submit" id="submit-return">돌아가기</button>
            </div>
        </div>
    </form>
</section>
