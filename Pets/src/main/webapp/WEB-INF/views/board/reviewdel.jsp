...
<section class="notice" id="delete-section">
    <div class="page-title" id="delete-page-title">
        <h2>입양 후기</h2>
        <h4 id="delete-question">정말로 <span id="delete-text">삭제</span>하실건가요?</h4>
        
        <!-- 삭제 확인 폼 -->
        <form method="POST" action="${pageContext.request.contextPath}/reviewdelok.do" id="delete-form">
            <input type="hidden" name="seq" value="${AdoptReviewListDTO.seq}">
            
            <div id="delete-buttons">
                <button class="btn btn-danger rounded-pill d-inline-flex flex-shrink-0 py-2 px-4" type="submit" id="delete-button">삭제하기</button>
                <button class="btn btn-secondary rounded-pill d-inline-flex flex-shrink-0 py-2 px-4" type="button" id="cancel-button" onclick="history.back();">취소</button>
            </div>
        </form>
    </div>
</section>
