...
#title {
  ...
  <h1 id="title" style="text-align: center;">보호소 병원 상세</h1>
<div id="map"></div>
    ...
    <div id="shelter-hospital-list" class="list-section">
        <div class="containerlist">
            ...
            <div id="shelter-list" class="list-column">
                <h3 id="shelter-title" class="section-title">상세 정보</h3>
                <table id="shelter-table" class="board-table">
                    <thead>
                        <tr>
                            <th scope="col" class="th-num">번호</th>
                            <th scope="col" class="th-title">이름</th>
                            <th scope="col" class="th-date">주소</th>
                            <th scope="col" class="th-date">전화번호</th>
                            <th scope="col" class="th-date">운영시간</th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach items="${shelterMapList}" var="ShelterMap">
                            <tr>
                                ...
                                <td class="shelter-address">${ShelterMap.shelter.telephone}</td>
                                <td class="shelter-phone">${ShelterMap.shelter.telephone}</td>
                                <td class="shelter-hour">${ShelterMap.shelter.telephone}</td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
