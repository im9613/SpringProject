    ...
    <form method="POST" action="${pageContext.request.contextPath}/reviewaddok">
        <div class="container">
            <table class="vertical">
                ...
                <tr>
                    <th>내용</th>
                    <td><textarea name="content" required class="full" style="height: 400px;"></textarea></td>
                </tr>
            </table>
            <div class="submit-btn-container">
                <button type="submit" class="btn btn-primary rounded-pill py-2 px-4">등록하기</button>
                <button type="submit" class="btn btn-primary rounded-pill py-2 px-4">돌아가기</button>
            </div>
        </div>
    </form>
</section>
